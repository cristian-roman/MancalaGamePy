...
class BoardComponent(GameComponent):
    ...
    def _draw(self):
        ...
        left_pot_x = self.board_coordinates[0] - self.pot_width + 100
        left_pot_y = self.board_coordinates[1] - 80
        self.left_pot_coordinates = (left_pot_x, left_pot_y)
        self.window.blit(self.pot, (left_pot_x, left_pot_y))

        right_pot_x = self.board_coordinates[0] + self.board_width - 100
        right_pot_y = self.board_coordinates[1] + self.board_height - self.pot_height + 100
